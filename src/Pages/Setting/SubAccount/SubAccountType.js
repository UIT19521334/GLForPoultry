...
function SubAccountType() {
	...
	const columns = [
		{
			field: 'SubTypeId',
			headerName: t('subaccount-type-code'),
			minWidth: 200,
			...
			<div className="main">
				...
				{dialogIsOpenNew && (
					<AlertDialog
						...
						content={
							<>
								{t('subaccount-type-code')}: {valueCode}
								<br /> {t('subaccount-type-name')}: {valueName}
										...
										<Stack spacing={3}>
											<Stack direction={'row'} spacing={2}>
												<div className="form-title">
													<div>{t('subaccount-type-code')}</div>
												</div>
												<Input
													variant="outlined"
													type="text"
											...
											<Stack direction={'row'} spacing={2}>
												<div className="form-title">
													<div>{t('subaccount-type-name')}</div>
												</div>
												<Input
													variant="outlined"
													size="large"
